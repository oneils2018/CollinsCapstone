...
with AedatFile(r"C:\Users\111gu\Desktop\Data\DV_FILES\dvSave-2021_08_24_10_44_21.aedat4") as f:
    ...
    ## Note: Filter 1 takes the +1 polarity data from the Aedat file and filters it based on distances from a specific point and its distance from its
    ## neighbors, calculated using the X and Y values, as well as time in the form of a Z axis.
    ## Filter 10 is the similar to Filter 1 but it filters -1 polarity instead.
    ## Filter 2 takes the output from Filter 1 and Filter 10 and filters it just using the distances from a hit point and its nearest neighbors, not taking
