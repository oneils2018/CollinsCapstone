...
def object_tracking(x_combined, y_combined, index3, x_hits, y_hits, x_hits0, y_hits0, sample_size, min_distance, min_hits, tolerance, max_tracking_iterations, directorySelVar, model):
